...
const Bidder = () => (
  ...
  >
    ...
    >
      ...
      <div className="p-2">
        Auction End
        <div className="font-bold text-center">0h: 20m: 10s</div>
      </div>
    </div>
    <div
  ...
  return (
    ...
    >
      <div className="">
        ...
        <h2 className="font-semibold text-3xl mb-5 text-yellow-300 py-1">
          domains, blogs, SaaS <i>& more</i>
        </h2>
        <p className="text-white font-light">
          <b>NO</b> more intermediaries
        </p>
        <p className="text-white mb-11 font-light"><b>NO</b> more scams and frauds</p>
        <div className="flex flew-row text-5xl mb-4">
          ...
          <button
              className="text-white text-sm p-2 px-4 bg-green-500 rounded-sm w-auto 
              flex flex-row justify-center items-center shadow-md shadow-gray-700"
              onClick={() => setGlobalState('boxModal', 'scale-100')}
            >
              List your domain
